#!/usr/bin/env python3
"""Read a TOML config file and generate a Python file with variables initialised from it."""
...
OUTPUT_FILE = Path("generated") / (toml_path.stem + "_variables.py")

with open(toml_path, "rb") as f:
    config = tomllib.load(f)

lines = [
    f"# Auto-generated from {toml_path.name} — do not edit manually.",
    "",
]
